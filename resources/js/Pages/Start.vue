<template>
    <div>
        ...
        <manta-remaining-time-frame remainingTime="6 jours" class="my-24">
        </manta-remaining-time-frame>
...
<script>
    ...
    import MantaRemainingTimeFrame from '../Mantastudio/RemainingTimeFrame'
